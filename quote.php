    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <a class="w-100 d-inline-flex align-items-center rounded overflow-hidden border border-primary"
                 href="tel:9045041670">
                    <span class="btn-lg-square bg-primary" style="width: 55px; height: 55px;">
                        <i class="fa fa-phone-alt text-white"></i>
                    </span>
                    <span class="fs-5 fw-medium mx-4">+91-9045041670</span>
                </a>
                <a class="my-2 w-100 d-inline-flex align-items-center rounded overflow-hidden border border-primary"
                 href="mailto:vimleshdax@gmail.com">
                    <span class="btn-lg-square bg-primary" style="width: 55px; height: 55px;">
                        <i class="fa fa-envelope text-white"></i>
                    </span>
                    <span class="fs-5 fw-medium mx-4">vimleshdax@gmail.com</span>
                </a>
            </div>
